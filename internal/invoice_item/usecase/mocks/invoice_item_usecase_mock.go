...
func (r *MockInvoiceItemRepository) CreateInvoiceItem(item model.InvoiceItem) error {
	ret := r.Called(item)
...
func (r *MockInvoiceItemRepository) GetAllInvoiceItems() []model.InvoiceItem {
	ret := r.Called()
...
func (r *MockInvoiceItemRepository) GetInvoiceItemByID(id int) (invItem model.InvoiceItem, err error) {
	ret := r.Called(id)
...
func (r *MockInvoiceItemRepository) GetInvoiceItemByNumber(number string) (invItem []model.InvoiceItem, err error) {
	ret := r.Called(number)
...
func (r *MockInvoiceItemRepository) UpdateInvoiceItemByID(id int, invItem model.InvoiceItem) error {
...
func (r *MockInvoiceItemRepository) DeleteInvoiceItemByID(id int) error {
	ret := r.Called(id)
